...
<body class="min-h-screen bg-zinc-50 dark:bg-zinc-900">
    ...
    <aside
        ...
        <div class="flex h-16 shrink-0 items-center px-6 border-b border-zinc-100 dark:border-zinc-800/50">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 font-bold text-zinc-900 dark:text-white">
                <div
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6">
            ...
            <!-- Settings Section -->
            <div class="mt-8">
                <h3 class="px-3 mb-2 text-xs font-semibold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">
                    Settings</h3>
                <div class="space-y-1">
    ...
    <div x-data="{ mobileMenuOpen: false }" class="lg:hidden">
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="flex h-16 items-center justify-between px-6 border-b border-zinc-100 dark:border-zinc-800/50">
                <a href="{{ route('dashboard') }}"
