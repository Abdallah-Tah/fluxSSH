...
<body class="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-100 dark:from-zinc-950 dark:via-zinc-900 dark:to-black font-sans antialiased text-zinc-900 dark:text-white selection:bg-emerald-500/20 dark:selection:bg-emerald-500/30 selection:text-emerald-900 dark:selection:text-emerald-400 transition-colors duration-300">
    <!-- Desktop Sidebar -->
    <aside class="fixed inset-y-0 left-0 z-50 w-72 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-xl border-r border-zinc-200 dark:border-zinc-800 hidden lg:flex lg:flex-col shadow-xl shadow-zinc-200/20 dark:shadow-black/40">
        <!-- Logo -->
        <div class="flex h-20 shrink-0 items-center px-6 border-b border-zinc-200 dark:border-zinc-800">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 group">
                <div class="relative w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 dark:from-emerald-600 dark:via-teal-600 dark:to-cyan-600 flex items-center justify-center shadow-lg shadow-emerald-500/30 dark:shadow-emerald-500/20 group-hover:shadow-emerald-500/50 dark:group-hover:shadow-emerald-500/30 transition-all duration-300 group-hover:scale-105">
                ...
                <div class="flex flex-col">
                    <span class="text-xl font-bold tracking-tight bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400 bg-clip-text text-transparent">FluxSSH <span class="text-lg">🔥</span></span>
                </div>
            </a>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-8">
            <div>
                <h3 class="px-3 mb-3 text-xs font-bold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Menu</h3>
                <div class="space-y-1">
                    <a href="{{ route('dashboard') }}"
                        class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 {{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-emerald-500/20 to-teal-500/20 dark:from-emerald-500/10 dark:to-teal-500/10 text-emerald-700 dark:text-emerald-400 shadow-sm shadow-emerald-500/10' : 'text-zinc-600 dark:text-zinc-400 hover:text-emerald-700 dark:hover:text-emerald-400 hover:bg-zinc-100 dark:hover:bg-white/5' }}">
                    ...
                    <a href="{{ route('servers') }}"
                        class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 {{ request()->routeIs('servers') || request()->routeIs('server.*') ? 'bg-gradient-to-r from-cyan-500/20 to-blue-500/20 dark:from-cyan-500/10 dark:to-blue-500/10 text-cyan-700 dark:text-cyan-400 shadow-sm shadow-cyan-500/10' : 'text-zinc-600 dark:text-zinc-400 hover:text-cyan-700 dark:hover:text-cyan-400 hover:bg-zinc-100 dark:hover:bg-white/5' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <div>
                <h3 class="px-3 mb-3 text-xs font-bold uppercase tracking-wider text-zinc-400 dark:text-zinc-500">Configuration</h3>
                <div class="space-y-1">
                    <a href="{{ route('profile.edit') }}"
                        class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 {{ request()->routeIs('profile.edit') ? 'bg-gradient-to-r from-purple-500/20 to-pink-500/20 dark:from-purple-500/10 dark:to-pink-500/10 text-purple-700 dark:text-purple-400 shadow-sm shadow-purple-500/10' : 'text-zinc-600 dark:text-zinc-400 hover:text-purple-700 dark:hover:text-purple-400 hover:bg-zinc-100 dark:hover:bg-white/5' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div class="border-t border-zinc-200 dark:border-zinc-800 p-4">
            <div class="flex items-center gap-3 p-2.5 rounded-xl hover:bg-zinc-100 dark:hover:bg-white/5 transition-all duration-200 cursor-pointer group">
                <div class="h-10 w-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 dark:from-zinc-800 dark:to-zinc-700 flex items-center justify-center text-sm font-bold text-white shadow-lg shadow-emerald-500/20 dark:shadow-sm">
                    {{ auth()->user()->initials() }}
                </div>
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-500 truncate">{{ auth()->user()->email }}</p>
                </div>
            </div>
        </div>
    </aside>
