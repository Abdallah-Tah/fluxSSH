...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data
    x-bind:class="$flux.appearance === 'system' ? '' : $flux.appearance">
...
<body
    class="antialiased min-h-screen flex flex-col selection:bg-primary-500/20 selection:text-primary-600 transition-colors duration-300">
    ...
    <header class="fixed top-0 w-full z-50 border-b border-border-subtle bg-bg-surface/80 backdrop-blur-xl">
        <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <a href="/" class="flex items-center gap-3 group">
                <div
                    class="w-10 h-10 rounded-xl bg-primary-500 flex items-center justify-center shadow-lg shadow-primary-500/20 group-hover:shadow-primary-500/40 transition-all duration-300">
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-[10px] text-text-tertiary font-medium tracking-wide uppercase mt-0.5">Mobile
            ...
            <nav class="hidden md:flex items-center gap-8">
                <a href="{{ route('about') }}"
                    class="text-sm font-medium text-text-secondary hover:text-text-primary transition-colors">About</a>
                <a href="{{ route('contact') }}"
                    class="text-sm font-medium text-text-secondary hover:text-text-primary transition-colors">Contact</a>
                <a href="{{ route('terms') }}"
                    class="text-sm font-medium text-text-secondary hover:text-text-primary transition-colors">Terms</a>
            </nav>

            <div class="flex items-center gap-4">
                @auth
                    <a href="{{ route('dashboard') }}"
                        class="text-sm font-medium text-text-secondary hover:text-text-primary transition-colors">Dashboard</a>
                @else
                    <a href="{{ route('login') }}"
                        class="text-sm font-medium text-text-secondary hover:text-text-primary transition-colors">Log in</a>
                    <a href="{{ route('register') }}"
                        class="group relative px-4 py-2 rounded-lg bg-text-primary text-bg-app text-sm font-semibold hover:bg-text-secondary transition-colors overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-text-tertiary">
                        <li><a href="{{ route('about') }}" class="hover:text-primary-500 transition-colors">About</a>
                        </li>
                        <li><a href="{{ route('contact') }}"
                                class="hover:text-primary-500 transition-colors">Contact</a></li>
                        <li><a href="{{ route('terms') }}" class="hover:text-primary-500 transition-colors">Terms</a>
                        </li>
            ...
            <div
                class="pt-8 border-t border-border-subtle flex flex-col md:flex-row items-center justify-between gap-4">
